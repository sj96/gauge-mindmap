...
class MindmapRenderer(
    ...
    private fun renderEmptyMessage(g2d: Graphics2D, viewport: MindmapViewport) {
        g2d.color = JBColor(Color(200, 200, 200), Color(200, 200, 200))
    ...
    private fun drawConnection(
        ...
        if (isLineHighlighted) {
            val highlightColor = JBColor(
                Color((branchColor.red + 100).coerceIn(0, 255),
    ...
    private fun drawNode(
        ...
        // Get node colors
        val (bgColor, borderColor, textColor) = MindmapColors.getNodeColors(bounds.node.level, bounds.colorIndex)
        ...
        if (isSelected || isHovered || isChildOfHovered) {
            val highlightColor = when {
                ...
                isHovered -> {
                    ...
                    val branchColor = MindmapColors.getBranchColor(bounds.colorIndex)
                    JBColor(
                        Color((branchColor.red + 80).coerceIn(0, 255),
